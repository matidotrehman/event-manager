...
namespace EventManager.Client.Pages
{
    public partial class ApplicationUsers
    {
        ...
        protected IEnumerable<EventManager.Server.Models.ApplicationUser> users;
        protected RadzenDataGrid<EventManager.Server.Models.ApplicationUser> grid0;
        ...
        protected async Task RowSelect(EventManager.Server.Models.ApplicationUser user)
        {
        ...
        protected async Task DeleteClick(EventManager.Server.Models.ApplicationUser user)
        {
            try
            {
